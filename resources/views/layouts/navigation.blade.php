            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        ...
                        <x-nav-link :href="route('billing.plansEmbebed')" :active="request()->routeIs('billing.plansEmbebed')">
                            {{ __('Planes Stripe') }}
                        </x-nav-link>
                        <x-nav-link :href="route('billing.my_subscription')" :active="request()->routeIs('billing.my_subscription')">
                            {{ __('Mi plan') }}
                        </x-nav-link>
                        <x-nav-link :href="route('billing.invoices')" :active="request()->routeIs('billing.invoices')">
                            {{ __('Mis facturas') }}
                        </x-nav-link>
                    </div>
                </div>
